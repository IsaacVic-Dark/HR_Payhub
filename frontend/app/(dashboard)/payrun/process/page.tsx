...
import PayrunTable from "@/app/(dashboard)/payrun/components/data-table-payruns";
      ...
      <div className="flex flex-1 flex-col">
        <div className="@container/main flex flex-1 flex-col gap-2">
          <div className="mt-4 mx-6 space-y-2">
            <h1 className="text-2xl font-medium">Upcoming Payrun</h1>
            <p className="text-base text-muted-foreground">
              This page shows upcoming payrun and we can process it
            </p>
          </div>
